...
export class PropertyReviewRepository extends BaseRepository {
  async findAll({ propertyId } = {}) {
    ...
    if (error) {
      throw new Error(
        `Error al obtener evaluaciones de propiedad: ${error.message}`,
      );
    }
    return data || [];
  }
  ...
  async create(reviewData) {
    ...
    if (error) {
      throw new Error(
        `Error al crear evaluacion de propiedad: ${error.message}`,
      );
    }
    return data;
  }
  ...
  async delete(id) {
    ...
    if (error) {
      throw new Error(
        `Error al eliminar evaluacion de propiedad: ${error.message}`,
      );
    }
  ...
  async deleteByPropertyId(propertyId) {
    ...
    if (error) {
      throw new Error(
        `Error al eliminar evaluaciones de propiedad ${propertyId}: ${error.message}`,
      );
    }
    return data || [];
  }
