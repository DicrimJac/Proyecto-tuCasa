...
//                 // Marcar esta estrella y todas las anteriores
//                 stars.forEach((s, i) => {
//                     if (i < value) {
...
//             // Mouse leave - restaurar según valor seleccionado
...
//             </div>
//             ${survey.comments ? <div class="history-comment">${survey.comments.substring(0, 60)}${survey.comments.length > 60 ? '...' : ''}</div> : ''}
//         </div>
//     `).join('');
// }

// // Generar estrellas para historial
...
//         <div style="margin-bottom: 1rem;">${generateRatingStars(survey.averageRating)}</div>
...
//         ${survey.comments ? <p><strong>Comentarios:</strong> ${survey.comments}</p> : ''}
//     `;
...
// // Resetear estrellas del formulario
// function resetStars() {
...
//         const averageRating = Math.round((rating1 + rating2 + rating3 + rating4 + rating5) / 5);
